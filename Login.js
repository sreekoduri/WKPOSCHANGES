...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-yellow-100 to-yellow-50 flex items-center justify-center px-4">
      <form
        onSubmit={handleSubmit}
        className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md space-y-6"
      >
        <h1 className="text-3xl font-extrabold text-center text-yellow-700">
          <img
            src={logo}
            alt="logo"
        ...
        <input
          ...
          className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm"
          required
        />
        ...
        <select
          ...
          className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm bg-white text-gray-400"
          required
        >
        ...
        <button
          ...
          className={`w-full py-3 rounded-lg text-white font-semibold transition duration-300 ${
            loading ? 'bg-yellow-50 cursor-not-allowed' : 'bg-yellow-600 hover:bg-yellow-700'
          }`}
          disabled={loading}
        >
